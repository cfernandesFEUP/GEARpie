...
The 3D output is not implemented by default, but is possible adding 3D entries to PLOTTING class. Every quantity calculated in CONTACT class is 3D. Central film thickness for an helical gear:
<p align="center">
